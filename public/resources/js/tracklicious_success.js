    ...
    $.ajax({
      ...
      success: function(result) {
        ...
        for (trackNumber = 0; trackNumber < resultsLength; trackNumber++) {
          $("#results").append(
            "<a href=" +
              result_obj.results.trackmatches.track[trackNumber].url +
              ' target="_blank">' +
              ...
              "<img src=" +
              result_obj.results.trackmatches.track[trackNumber].image[1][
                "#text"
              ] +
              ">" +
              "</div>" +
              ...
              numeral(
                result_obj.results.trackmatches.track[trackNumber].listeners
              ).format("0, 0") +
              "</div>" +
              "</div>" +
              "</a>"
